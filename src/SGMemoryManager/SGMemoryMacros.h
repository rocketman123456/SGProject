...
#if defined(_DEBUG)
#	define SG_NEW new(_NORMAL_BLOCK,__FILE__, __LINE__)
#else
#	define SG_NEW new
#endif
...
// macro below.
//---------------------------------------------------------------------------------------------------------------------
#define SG_MEMORYPOOL_DECLARATION(__defaultNumChunks__) \
    public: \
		static SGMemoryPool* s_pMemoryPool; \
...
//---------------------------------------------------------------------------------------------------------------------
#define SG_MEMORYPOOL_DEFINITION(_className_) \
...
// pool yourself.
//---------------------------------------------------------------------------------------------------------------------
#define SG_MEMORYPOOL_AUTOINIT_DEBUGNAME(_className_, _numChunks_, _debugName_) \
...
#define SG_MEMORYPOOL_AUTOINIT(_className_, _numChunks_) SG_MEMORYPOOL_AUTOINIT_DEBUGNAME(_className_, _numChunks_, #_className_)
